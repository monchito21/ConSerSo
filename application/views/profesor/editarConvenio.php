...
<form action="<?=base_url()?>profesorControlador/actualizaConvenio/<?=$idConvenio?>" method="post">
  <fieldset>
    <legend>Nuevo Convenio</legend>
       <div class="row">
      <div class="one third padded">
        <label for="fecha_inicial">Fecha Inicial</label>
        <input type="date" name="fecha_inicial" class="" id="fecha_inicial" value="<?=$fecha_inicial?>" required>
      </div>
      <div class="one third padded">
        <label for="fecha_final">Fecha Final</label>
        <input type="date" name="fecha_final" class="" id="fecha_final" value="<?=$fecha_final?>" required>
      </div>
      <div class="one third padded">
        <label for="horas_servicio">Tiempo de Servicio</label>
        <input name="horas_servicio" id="horas_servicio" type="text" placeholder="Numero de horas" value="<?=$horas_servicio?>" required>
      </div>
    </div>
      <div class="row">
      <div class="one third padded">
  ...
  <div class="row" align="center">
    ...
    <a class="red button" href="<?=base_url()?>profesorControlador/detallesConvenio/<?=$idConvenio?>">Cancelar</a>
</div>
</form>
</div>
</div>
