...
<nav class="nav green" title="Servicio Social UV">
  <ul>
    ...
    <li><button><i class=" icon-list"></i> Administrar</button>
      <ul>
        <li><a href="<?=base_url()?>profesorControlador/verAlumnos"><i class="icon-archive"></i> Alumnos</a ></li>
        <li><a href="<?=base_url()?>profesorControlador/verDocentes"><i class="icon-male"></i> Docentes</a></li>
         <li><a href="<?=base_url()?>profesorControlador/verDependencias"><i class="icon-building"></i> Dependencias</a></li>
      </ul>
    </li>
...
<li><a href="<?=base_url()?>profesorControlador/verConvenio"><i class=" icon-link"></i> Convenios</a></li>
