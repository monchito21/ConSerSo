...
<form  id="form" method="GET" action="<?=base_url()?>main/buscaCartaAceptacion">
    ...
    <?php
          if ($result != FALSE){
            ...
            echo "<tr>";
              ...
              echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
              echo "<a href='".base_url()."main/eliminarCartaAceptacion/".$row->idCartaAceptacion."'><i class='icon-remove icon-2x' style='color:red'></i></a></td>";
